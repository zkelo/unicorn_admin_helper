...
local data = inicfg.load({
    ...
    commands = {
        ...
        '/so - выйти из слежки',
        '/m {p:ID игрока} {d:Время} {s:Причина} - выдать бан чата',
        '/mx {n:Никнейм игрока} {d:Время} {s:Причина} - выдать бан чата',
        '/mo {p:ID игрока} - выдать бан чата за оскорбление',
        '/mm {p:ID игрока} - выдать бан чата за мат',
        '/mf {p:ID игрока} - выдать бан чата за флуд',
        '/ms {p:ID игрока} - выдать бан чата за спам',
        '/mq {p:ID игрока} - выдать бан чата за упом. родных',
        '/sm {p:ID игрока} {d:Время} - изменить время бана чата',
        '/k {p:ID игрока} {s:Причина} - кикнуть',
        '/j {p:ID игрока} {d:Время} {s:Причина} - посадить в тюрьму',
        '/w {p:ID игрока} {s:Причина} - выдать предупреждение',
        '/bl {n:Никнейм игрока} - заблокировать аккаунт',
        '/b {p:ID игрока} {s:Причина} - забанить игрока',
        '/bx {n:Никнейм игрока} {s:Причина} - забанить игрока',
        '/bc {p:ID игрока} - забанить игрока за чит',
        '/um {p:ID игрока} - снять бан чата',
        '/umx {n:Никнейм игрока} - снять бан чата',
        '/uw {p:ID игрока} - снять предупреждение',
        '/uj {p:ID игрока} - выпустить из тюрьмы',
        '/ub {n:Никнейм игрока} - разбанить',
        '/ubl {n:Никнейм игрока} - разблокировать аккаунт'
    }
}, configFilename)
