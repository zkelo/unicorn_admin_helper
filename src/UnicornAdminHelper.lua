...
local data = inicfg.load({
    ...
    commands = {
        ...
        '/so - выйти из слежки',
        '/m {pn:ID или никнейм игрока} {d:Время} {s:Причина} - выдать бан чата',
        ...
        '/b {pn:ID или никнейм игрока} {s:Причина} - забанить игрока',
        '/bc {pn:ID или никнейм игрока} - забанить игрока за чит',
        '/um {pn: ID или никнейм игрока} - снять бан чата',
